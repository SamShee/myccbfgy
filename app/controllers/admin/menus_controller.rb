class Admin::MenusController < Admin::AuthencatedController
  ...
  private
    ...
    def admin_menu_params
      params.require(:admin_menu).permit(:name, :url, :icon, :icon_location, :created_by, :updated_by, :enabled, :is_enabled, :is_locked, :is_expired, :status, :type, :parent_id)
    end
end
